...
let Tab2Page = class Tab2Page {
    ...
    searchEventFired() {
        this.api.getDadesPaisosCompletes(this.searchTerm).subscribe((data) => {
            this.results = data;
        });
    }
    obrirPais(p) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Cercar\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n \n    <ion-searchbar animated placeholder=\"Cercar país\" [(ngModel)]=\"searchTerm\" (ionInput)=\"searchEventFired()\"></ion-searchbar>\n    <ion-list *ngIf=\"results\" tappable (click)=\"obrirPais(results[0].Country)\">\n      <ion-item>{{ results[0].Country }}</ion-item> \n    </ion-list>\n  \n</ion-content>\n");
